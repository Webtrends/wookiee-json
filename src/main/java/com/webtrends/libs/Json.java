...
public class Json {
     ...
     *
     * This is intended to be used when wookiee starts up.  By default, Wookiee will inject its own object mapper here,
     * but this mapper can be overridden either by a custom component or from onStart.
     */
